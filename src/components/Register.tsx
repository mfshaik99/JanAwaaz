...
export function Register() {
  ...
  const handleEmailRegister = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const isAdmin = ['mfshaik99@gmail.com', 'chirudeepartham@gmail.com', 'maazeem206@gmail.com'].includes(email);
      ...
      toast.success(isAdmin ? 'Admin registration successful' : 'Registration successful');
  ...
  const handleVerifyOtp = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await setDoc(doc(db, 'users', result.user.uid), {
        ...
        role: 'citizen',
        createdAt: new Date().toISOString()
      }, { merge: true }); // Use merge in case they already exist
